...
SECRET_KEY = '9%x9%fb*-x_l4q9*q@cbd0^-cqi49z4u&6ggl2y415aar=a)i-'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(PROJECT_ROOT,'compassTraining/templates/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SECURE_PROXY_SSL_HEADER = ('HHTP_X_FORWARD_PROTO','https')
